We are now focusing on the development of a bayesian optimization routine. Since we have a tonne of knobs, we have manually selected a few. This will be called optimization routine year1. In this, we will record the state of Year1, then take the previous decisions of Year1, suggest some values, apply those values, and see year 2. We want to optimize for the following - 
